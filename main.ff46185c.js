...
var Menu = function Menu(parent) {
  ...
  this.link.forEach(function (item) {
    item.addEventListener('click', function () {
      _this.section.forEach(function (elem) {
        return item.getAttribute('data-link') === elem.getAttribute('data-section') ? elem.scrollIntoView({
          behavior: 'smooth'
        }) : null;
      });
    });
...
},{}],"../components/menu/burger/menu-burger.js":[function(require,module,exports) {
"use strict";
...
var MenuBurger = function MenuBurger(parent) {
  var _this = this;
  ...
  this.parent.addEventListener('click', function () {
    return !_this.menu.classList.contains('menu--open') ? _this.menu.classList.add('menu--open') : _this.menu.classList.remove('menu--open');
  });
};
...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./resources\\images\\hero.jpg":[["hero.0e03aae8.jpg","../resources/images/hero.jpg"],"../resources/images/hero.jpg"],"./resources\\images\\music.jpg":[["music.6eba5ec4.jpg","../resources/images/music.jpg"],"../resources/images/music.jpg"],"_css_loader":"C:/Users/hafud/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../main.js":[function(require,module,exports) {
"use strict";
...
var _menuBurger = _interopRequireDefault(require("./components/menu/burger/menu-burger"));

require("./main.scss");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var menu = Array.from(document.querySelectorAll('.menu-burger'));
menu.forEach(function (item) {
  return new _menuBurger.default(item);
});
Array.from(document.querySelectorAll('.menu').forEach(function (item) {
  return new _menu.default(item);
}));
},{"normalize.css":"../../node_modules/normalize.css/normalize.css","@fortawesome/fontawesome-free/css/all.css":"../../node_modules/@fortawesome/fontawesome-free/css/all.css","./components/menu/menu":"../components/menu/menu.js","./components/menu/burger/menu-burger":"../components/menu/burger/menu-burger.js","./main.scss":"../main.scss"}],"C:/Users/hafud/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "7863" + '/');
